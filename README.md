...
**Note**: While the SQL queries and analytical logic in this repository were developed and tested by me, the descriptive text and visualizations in this README are based on a project template. Consequently, some specific values or graphs in this document may vary from the actual query outputs.